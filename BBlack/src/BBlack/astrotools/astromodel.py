...
class AstroModel:
    ...
    def sample_catalog_one_cpu(self, args):
        ...
        :param tuple : This tuple contains the same argument than the ones of sample_catalog. This tuple format is used to
        make concurrent futures work.
        :returns samples : pandas dataframe Samples generated by this CPU.
        """
